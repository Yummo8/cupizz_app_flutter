      ...
      body: Skeleton(
        ...
        child: !widget.enableRefresh
            ...
            : RefreshIndicator(
                ...
                child: _body(user, context, _theme),
              ),
      ),
    );
  }
        ...
        SliverList(
          ...
          if (user == null || user.educationLevel != null) ...[
            ...
            RowInfo(
              iconData: Icons.school,
              semanticLabel: '',
              title: user?.educationLevel?.displayValue ?? 'Education Level',
            ),
          ],
          // const SizedBox(height: 16.0),
          // RowInfo(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: model.isAddingImage
                            ? null
                            : () {
                                AnswerQuestionScreen.answerQuestion(context);
                              },
                        style: TextButton.styleFrom(
                          backgroundColor: _theme.primaryColor.withOpacity(0.2),
                        ),
